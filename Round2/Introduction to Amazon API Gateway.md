...
```
![avatar](image/4-2.png)

- Set the basic settings 
> - Descripting: Provaide a random FAQ
- Under Add triggers click API Gateway
![avatar](image/4-3.png)
![avatar](image/4-4.png)

## Test the Lambda function
- click the right arrow to view the API
- Use the invoke URL to test API
![avatar](image/4-5.png)
- Click Test then configure:
> - Event name: BasicTest
> - Delete the provided keys and values
- Click Create
![avatar](image/4-6.png)
![avatar](image/4-7.png)
